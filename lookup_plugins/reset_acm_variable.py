...
_constant.TYPE_PASSWD = "password"
_constant.TYPE_NAMEAND_PASSWORD = "all"
class LookupModule(LookupBase):
    def retrieve_secrets(self, terms):
        ...
        appid = terms[0]
        query = terms[1]
        if _constant.TYPE_PASSWD == terms[2]:
            type = _constant.TYPE_PASSWD
        else:
            type = _constant.TYPE_NAMEAND_PASSWORD
        ...
        if type == _constant.TYPE_PASSWD:
            secrets.append(really_password)
        else:
            account = dict()
            account['name'] = really_account
            account['password'] = really_password
